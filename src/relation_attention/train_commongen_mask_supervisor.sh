#!/bin/bash
#SBATCH --job-name=bart_com_mask_sup
...
#SBATCH --gres=gpu:nvidia_a100-sxm4-40gb:1#,shard:7 gres:shard:7
...
PYTHONPATH=.:$PYTHONPATH python3 $2 --datasets "${datasets[@]}" --experiment_type "mask" --knowledge "conceptnet" --head_mask_type "none" \
                                    ...
                                    --use_dynamic_heads "yes" --pre_model "facebook/bart-large" --epochs 10