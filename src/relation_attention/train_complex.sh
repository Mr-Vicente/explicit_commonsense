...
python3 pre_fast_tokenization.py --datasets "${datasets[@]}" --experiment_type "relations" --knowledge "conceptnet" &&
python3 $2 --datasets "${datasets[@]}" --experiment_type "relations" --knowledge "conceptnet"