...
COMET_API_KEY=$API_KEY COMET_PROJECT_NAME=$PROJECT_NAME python3 $2 --datasets "${datasets[@]}" --experiment_type "mask" --knowledge "conceptnet" --head_mask_type "random"