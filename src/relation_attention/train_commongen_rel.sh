...
PYTHONPATH=.:$PYTHONPATH python3 $2 --datasets "${datasets[@]}" --experiment_type "relations" --knowledge "conceptnet" --head_mask_type "none" \
                                    --scoring_type "default" --loss_type "default" --learn_pos_embed_encoder "yes" --use_context "no" --use_extra_relations "yes" \
                                    --pre_model "facebook/bart-large" --epochs 10 --max_length 32