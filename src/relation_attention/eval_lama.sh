...
###SBATCH --gres=shard:nvidia_a100-pcie-40gb:2
...
#python3 $2 --experiment_type "default" --model_path "./trained_models/default_none_none_2_facebook-bart-large_3e-05_16/checkpoint-198700" &&
#python3 $2 --experiment_type "relations" --knowledge "conceptnet" --model_path "./trained_models/relations_conceptnet_none_22_facebook-bart-large_3e-05_72/checkpoint-43820" &&
#python3 $2 --experiment_type "mask" --knowledge "conceptnet" --model_path "./trained_models/mask_conceptnet_random_2_facebook-bart-large_3e-05_72/checkpoint-43820" &&
#cd eval &&
#python3 evals_to_plots.py --dataset "lama"
...
#python3 $2 --experiment_type "relations" --knowledge "conceptnet" --model_path "/home/fm.vicente/data/model_weights/trained_models_2/facebook-bart-large_relations_commongen_conceptnet_none_L-cp-rp-def_DS-default_wLearnEmb_7/checkpoint-4653" &&
