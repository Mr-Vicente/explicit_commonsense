...
data_dict = {
    ...
    'commongen': {
        'local': ('commongen.json',
                  '/Users/mrvicente/Documents/Education/Thesis/code/f_papers/explicit_commonsense/src/data'),
...
if __name__ == '__main__':
    ...
    parser.add_argument("--dataset", type=str, choices=["commongen", "eli5", "commonsense_qa", "stackexchange_qa"], default="eli5", help="dataset")
    parser.add_argument("--knowledge", type=str, choices=["conceptnet", "swow", "cskg"], default=None, help="knowledge")
    ...
    write_dict_2_json_file(relations_mappings,
                           f'model_kgs/{type_file}_{DATA_TYPE.value}_{SELECTED_KG.value}_relation_data.json')
